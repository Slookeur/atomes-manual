...
\subsubsection*{The \aob{INFO} section}
...
\subsubsection*{The \aob{CPMD} section}
...
\subsubsection*{The \aob{DFT} section}
...
\subsubsection*{The \aob{VDW} section}
...
\subsubsection*{The \aob{PROP} section}
...
\subsubsection*{The \aob{SYSTEM} section}
...
\subsubsection*{The \aob{ATOMS} section}
...
\subsubsection*{The \aob{CP2K input structure} section}
...
\subsubsection*{The \aob{GLOBAL} section}
...
\subsubsection*{The \aob{FORCE\_EVAL} section}

Describe the details of the forces evaluation process.

\subsubsection*{The \aob{SUBSYS} section}

\subsubsection*{The \aob{MOTION} section}

...
% ISAACS Users manual	
%
\titleEN{\hspace{-1cm}\includegraphics*[width=17cm, keepaspectratio=true, draft=\ddst]{img/overview3}\\ \bigskip User manual \atomes\ v1.0}
...
% Intro
\include{chap-1/chap-1}

% Programming framework
\include{chap-2/chap-2}

% Features
\include{chap-3/chap-3}

% PC analysis
\include{chap-4/chap-4}

% Vis analysis
\include{chap-5/chap-5}

% Vis edition
\include{chap-6/chap-6}
